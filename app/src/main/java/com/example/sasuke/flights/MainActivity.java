        ...
        if (mylocation != null) {
            ...
            try {
               ...
               countrys = addresses.get(0).getCountryName();
                ...
                Toast.makeText(getApplicationContext(),"can't find location searching..",Toast.LENGTH_SHORT).show();
               onStart();
            }

                 latitudeTextView.setText(address + "," + city + ",");
                 longitudeTextView.setText(" " + state + "," + countrys+ "," + postalCode);
